...
- **Versão de política identifica comportamento, não intenção.** Mudança que altere o resultado de alguma execução possível — ou o nome de um sinal publicado — exige bump, mesmo com pesos e faixas intactos. Ver [ADR 025](docs/decisions/025-versao-de-politica-identifica-comportamento.md).
